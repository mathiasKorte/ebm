...
hidden if the `ebm_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ebm_DEVELOPER_MODE` to the configure
...
Runs the executable target `ebm_exe`.
